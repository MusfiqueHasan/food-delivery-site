...
const Banner = () => {
    return (
        <div className="banner">
            <div className=" grid md:grid-cols-3 grid-cols-1 md:px-28">
                <div className=" md:h-screen  px-5 flex flex-col justify-center md:break-normal break-all col-span-2">
                    <h1 className=" md:text-6xl text-xl text-white font-bold mb-6  font-serif w-72 md:w-full">Order Healthy And Fresh Food Any Time</h1>
