    ...
    return (
        <div className="banner">
            ...
            <div className=" grid md:grid-cols-2 grid-cols-1">
                <div className=" h-screen md:pl-24 md:px-0 px-5  flex flex-col justify-center">
                    <h1 className=" md:text-6xl text-xl text-white font-bold mb-6  font-serif md:w-full">Order Healthy And Fresh Food Any Time</h1>
                    <p className="text-white md:text-xl text-xs text-justify w-60 md:w-full ">Italian food makes people think of big family dinners. So you may want to position your restaurant as a place to bring the whole family.</p>
                    <h4 className="text-white md:text-2xl my-6 border-b-2 w-60 font-mono font-bold ">Popular Restaurant</h4>
                    <div className=" md:w-4/5 w-1/5 flex justify-between">
